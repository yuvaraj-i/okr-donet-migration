...
namespace helloWorld.Controllers
{
	...
	public class SkillController : ControllerBase
	{
        ...
        [HttpPut("poc/{id}"), Authorize]
        public IActionResult updateUserPoc(EditAccomplishmentRequest accomplishmentRequest, int id)
        {
        ...
        public IActionResult deleteUserPoc(int id)
        {
            _logger.LogInformation("SkillController updateUserPoc");
            try
            {
